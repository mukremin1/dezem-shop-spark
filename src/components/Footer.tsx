...
const Footer: React.FC = () => {
  ...
  // WhatsApp link oluştur (env varsa öncelikli)
  ...
  // JSON-LD'ye telefon ve adres ekle
  ...
  const termsContent = (
    <>
      ...
      <section aria-labelledby="terms-intro">
        ...
        <p style={{ marginTop: 0 }}>
          Bu Kullanım Şartları ("Şartlar"), {siteName} tarafından sunulan web sitesinin
          ve hizmetlerinin ("Hizmet") kullanımına ilişkin koşulları belirler. Hizmeti
